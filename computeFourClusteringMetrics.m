%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                        %
% The code to calculate four clustering evaluation metrics, namely, NMI, %
% ARI, Accuracy, and Purity. If you find the helpful in your research,   %
...
function results = computeFourClusteringMetrics(labels,true_labels)
...
results = [NMI,ARI,accuracy,purity];
